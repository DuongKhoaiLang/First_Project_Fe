...
function Options() {
    return (
        <div className='z-0'>
            ...
            <div className="flex flex-row h-[450px] w-3/4 m-auto space-x-5 mt-[10px]">

                <div className='basis-1/3 relative  bg-[#2e1a4f] border-[#775780] border-3 rounded-[25px] h-3/4'>
